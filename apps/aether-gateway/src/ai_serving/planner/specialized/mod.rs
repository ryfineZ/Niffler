...
pub(crate) use self::image::{
    ...
    build_local_image_sync_plan_and_reports_for_kind, build_openai_image_passthrough_headers,
    ...
    openai_image_uses_codex_native_generation, openai_image_uses_images_passthrough, set_local_openai_image_execution_exhausted_diagnostic,
};
