...
pub(crate) use self::api::{
    gemini_generate_content_response_has_visible_output, is_openai_responses_compact_format,
};
...
pub(crate) fn build_execution_runtime_auth_context(
    ...
    ExecutionRuntimeAuthContext {
        ...
        api_key_group_id: auth_context.api_key_group_id.clone(),
        api_key_group_name: auth_context.api_key_group_name.clone(),
        sales_multiplier: auth_context.sales_multiplier,
        model_sales_multipliers: auth_context.model_sales_multipliers.clone(),
