...
pub(crate) use self::catalog::{
    ...
    encrypt_catalog_secret_with_fallbacks, masked_catalog_api_key, merge_codex_metadata_bucket,
    merge_codex_response_header_metadata_bucket, parse_catalog_auth_config_json,
    provider_catalog_key_supports_format,
    provider_key_account_label_from_auth_config, provider_key_health_summary,
