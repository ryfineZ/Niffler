...
const messages = {
  'zh-CN': {
    ...
    billing: {
      ...zhCN.billing,
      walletDebtNotice: '钱包当前欠费 {amount}。已有套餐仍可正常使用，请先充值结清欠费后再购买或续费套餐。',
      walletDebtBuyDisabled: '请先结清钱包欠费',
  ...
  'en-US': {
    ...
    billing: {
      ...enUS.billing,
      walletDebtNotice: 'Your wallet owes {amount}. Existing plans remain usable; clear the debt before buying or renewing a plan.',
      walletDebtBuyDisabled: 'Clear wallet debt first',
