...
pub use providers::{
    ...
    DefaultProviderPoolAdapter, GeminiCliProviderPoolAdapter, GrokOAuthProviderPoolAdapter,
    ...
    GEMINI_CLI_RETRIEVE_USER_QUOTA_PATH, GEMINI_CLI_USER_AGENT, GROK_OAUTH_BILLING_MONTHLY_PATH,
...
mod tests {
    ...
    fn preset_payload_derives_provider_support_from_capabilities() {
        ...
        assert_eq!(
            ...
            json!(["codex", "grok", "grok_oauth", "kiro", "windsurf"])
        );
        assert_eq!(
