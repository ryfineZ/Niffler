...
impl<'a> DialectSql<'a> {
    ...
    pub const fn postgres(postgres: &'a str) -> Self {
        Self {
            common: None,
...
mod tests {
    ...
    #[test]
    fn select_statement_keeps_bind_order_and_search() {
